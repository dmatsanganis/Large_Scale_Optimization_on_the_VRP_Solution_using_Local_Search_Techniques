...
############################## LOCAL SEARCH OPERATORS ############################################################
    ...
    def LocalSearch(self, operator):
        ...
        #Here we update and keep the actual best solution of Local Search Operator Applied
...
############################### RELOCATION MOVE FUNCTIONS ####################################################
    ...
    def ApplyRelocationMove(self, rm: RelocationMove):
        ...
        print("The relocation move cost for the applied relocation is", rm.moveCost)
    ...
    def FindBestRelocationMove(self, rm):
        ...
        # # Third case the target route to always be the max cost route
        # targetRouteIndex = originRouteIndex
        # rt2: Route = self.sol.routes[targetRouteIndex]
        # for originRouteIndex in range(0, targetRouteIndex):
        #     rt1: Route = self.sol.routes[originRouteIndex]
        #     for originNodeIndex in range(1, len(rt1.sequenceOfNodes) - 1):
        #
        #         A = rt1.sequenceOfNodes[originNodeIndex - 1]
        ...
        #                                  self.distanceMatrix[F.ID][G.ID]
        #
        #             moveCost = targetRtCostChange
        #
        #             if (moveCost < rm.moveCost) and ((originRtCostChange + rt2.cost) < self.sol.cost) and (
        #                     (targetRtCostChange + rt1.cost) < self.sol.cost):
        #                 self.StoreBestRelocationMove(originRouteIndex, targetRouteIndex, originNodeIndex, targetNodeIndex, moveCost, originRtCostChange, targetRtCostChange, rm)
        #
        # for originRouteIndex in range(targetRouteIndex + 1, len(self.sol.routes)):
        #     rt1: Route = self.sol.routes[originRouteIndex]
        #     for originNodeIndex in range(1, len(rt1.sequenceOfNodes) - 1):
        #
        #         A = rt1.sequenceOfNodes[originNodeIndex - 1]
...
############################### SWAP MOVE FUNCTIONS ############################################################
            ...
            for secondRouteIndex in range(firstRouteIndex, len(self.sol.routes)):
                ...
                for secondNodeIndex in range(startOfSecondNodeIndex, len(rt2.sequenceOfNodes) - 1):
                    ...
                    # rt1 != rt2
                        ...
                        if moveCost < 0 and moveCost < sm.moveCost and rt2.cost + costChangeSecondRoute < rt1.cost + moveCost:
    ...
    def ApplySwapMove(self, sm):
        ...
        if rt1 == rt2:
            ...
            rt1.load = rt2.load + b1.demand - b2.demand
        ...
        print("The relocation move cost for the applied relocation is", sm.moveCost)
        print("old new", oldCost, newCost)
        print("The estimated cost from the apply function of the latest solution is", self.sol.cost)
...
############################### TWO OPT MOVE FUNCTIONS ############################################################
    ...
    def FindBestTwoOptMove(self, top):
        ...
        print("The index of the max cost route is", rtInd1)
        ...
        for nodeInd1 in range(0, len(rt1.sequenceOfNodes) - 1):
                ...
                for rtInd2 in range(rtInd1, len(self.sol.routes)):
                    ...
                    for nodeInd2 in range(start2, len(rt2.sequenceOfNodes) - 1):
                        ...
                        if moveCost < 0 and moveCost < top.moveCost :
    ...
    def ApplyTwoOptMove(self, top):
        ...
        print("The relocation move cost for the applied relocation is", top.moveCost)
        print("The estimated cost from the apply function of the latest solution is", self.sol.cost)
